        ...
        <div className="about-sections">
            ...
            <div className="about-right">
                ...
                <div className="about-skills">
                    <div className="about-skill"><p>Spring Boot</p><hr style={{width:"30%"}}/></div>
                    <div className="about-skill"><p>Javv</p><hr style={{width:"50%"}}/></div>
                    <div className="about-skill"><p>HTML & CSS</p><hr style={{width:"60%"}}/></div>
                    <div className="about-skill"><p>React & Angular</p><hr style={{width:"50%"}}/></div>
                </div>
            </div>
        </div>
